  ...
  return (
    ...
    <main className="pt-16 mb-20">
      <Routes>
          ...
          <Route path="/addassets" element={<ProtectedRoute><PopUpformater><AddAsset/></PopUpformater></ProtectedRoute>} />
          <Route path="/updateAssets" element={<ProtectedRoute><PopUpformater><UpdateAssets/></PopUpformater></ProtectedRoute>} />
